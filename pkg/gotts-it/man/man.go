// Package man provides manual page generation functionality for the gotts-it application.
//
// This package creates Unix manual pages (man pages) for the gotts-it CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/gotts-it/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./gotts-it man > gotts-it.1
package man
...
// for the gotts-it application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates gotts-it's command line manpages",
		SilenceUsage:          true,
