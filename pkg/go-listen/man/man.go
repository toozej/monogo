// Package man provides manual page generation functionality for the go-listen application.
//
// This package creates Unix manual pages (man pages) for the go-listen CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/go-listen/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./go-listen man > go-listen.1
package man
...
// for the go-listen application. The command traverses the root command tree
