// Package man provides manual page generation functionality for the lego-stego application.
//
// This package creates Unix manual pages (man pages) for the lego-stego CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/lego-stego/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./lego-stego man > lego-stego.1
package man
...
// for the lego-stego application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates lego-stego's command line manpages",
		SilenceUsage:          true,
