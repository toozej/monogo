// Package man provides manual page generation functionality for the ghreleases2rss application.
//
// This package creates Unix manual pages (man pages) for the ghreleases2rss CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/ghreleases2rss/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./ghreleases2rss man > ghreleases2rss.1
package man
...
// for the ghreleases2rss application. The command traverses the root command tree
