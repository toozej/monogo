// Package man provides manual page generation functionality for the kmhd2playlist application.
//
// This package creates Unix manual pages (man pages) for the kmhd2playlist CLI
...
// Example usage:
//
//	import "github.com/toozej/kmhd2playlist/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./kmhd2playlist man > kmhd2playlist.1
package man
...
// for the kmhd2playlist application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates kmhd2playlist's command line manpages",
		SilenceUsage:          true,
