// Package man provides manual page generation functionality for the files2prompt application.
//
// This package creates Unix manual pages (man pages) for the files2prompt CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/files2prompt/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./files2prompt man > files2prompt.1
package man
...
// for the files2prompt application. The command traverses the root command tree
