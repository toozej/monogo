...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/RSSFFS/man"
//
...
// for the RSSFFS application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates RSSFFS's command line manpages",
		SilenceUsage:          true,
