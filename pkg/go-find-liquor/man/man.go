// Package man provides manual page generation functionality for the go-find-liquor application.
//
// This package creates Unix manual pages (man pages) for the go-find-liquor CLI
...
// Example usage:
//
//	import "github.com/toozej/monogo/pkg/go-find-liquor/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./go-find-liquor man > go-find-liquor.1
package man
...
// for the go-find-liquor application. The command traverses the root command tree
...
//	// ./go-find-liquor man > go-find-liquor.1
//	// man ./go-find-liquor.1
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates go-find-liquor's command line manpages",
		SilenceUsage:          true,
