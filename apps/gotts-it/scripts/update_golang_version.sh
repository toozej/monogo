...
FILES_NEEDING_UPDATES="${GIT_REPO_ROOT}/Dockerfile ${GIT_REPO_ROOT}/Dockerfile.distroless ${GIT_REPO_ROOT}/.github/workflows/ci.yaml ${GIT_REPO_ROOT}/.github/workflows/release.yaml ${GIT_REPO_ROOT}/.github/workflows/weekly-docker-refresh.yaml"
