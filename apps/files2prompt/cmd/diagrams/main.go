// Package main provides diagram generation utilities for the files2prompt app.
package main
...
const (
	appName     = "files2prompt"
	appBinary   = "files2prompt"
	appPath     = "apps/files2prompt"
	appMainPath = "apps/files2prompt"
	outputDir   = "docs/diagrams/files2prompt"
)
