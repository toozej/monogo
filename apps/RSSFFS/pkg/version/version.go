...
//
//	go build -ldflags "-X github.com/toozej/RSSFFS/pkg/version.Version=v1.0.0 \
//	  -X github.com/toozej/RSSFFS/pkg/version.Commit=abc123 \
//	  -X github.com/toozej/RSSFFS/pkg/version.Branch=main"
//
// Example usage:
//
...
// Build-time injection example:
//
//	go build -ldflags "-X github.com/toozej/RSSFFS/pkg/version.Version=v1.2.3"
var (
