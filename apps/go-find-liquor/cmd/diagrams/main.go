// Package main provides diagram generation utilities for the go-find-liquor app.
package main
...
const (
	appName     = "go-find-liquor"
	appBinary   = "go-find-liquor"
	appPath     = "apps/go-find-liquor"
	appMainPath = "apps/go-find-liquor"
	outputDir   = "docs/diagrams/go-find-liquor"
)
