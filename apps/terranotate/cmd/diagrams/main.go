// Package main provides diagram generation utilities for the terranotate app.
package main
...
const (
	appName     = "terranotate"
	appBinary   = "terranotate"
	appPath     = "apps/terranotate"
	appMainPath = "apps/terranotate"
	outputDir   = "docs/diagrams/terranotate"
)
