// Package main provides diagram generation utilities for the trails-completionist app.
package main
...
const (
	appName     = "trails-completionist"
	appBinary   = "trails-completionist"
	appPath     = "apps/trails-completionist"
	appMainPath = "apps/trails-completionist"
	outputDir   = "docs/diagrams/trails-completionist"
)
