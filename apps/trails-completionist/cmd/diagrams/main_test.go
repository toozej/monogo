...
func TestGeneratedAppMetadata(t *testing.T) {
	if appName != "trails-completionist" {
		t.Fatalf("appName = %q, want trails-completionist", appName)
	}
	if appBinary != "trails-completionist" {
		t.Fatalf("appBinary = %q, want trails-completionist", appBinary)
	}
	if outputDir != "docs/diagrams/trails-completionist" {
		t.Fatalf("outputDir = %q, want docs/diagrams/trails-completionist", outputDir)
	}
}
