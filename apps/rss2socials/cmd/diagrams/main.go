// Package main provides diagram generation utilities for the rss2socials app.
package main
...
const (
	appName     = "rss2socials"
	appBinary   = "rss2socials"
	appPath     = "apps/rss2socials"
	appMainPath = "apps/rss2socials"
	outputDir   = "docs/diagrams/rss2socials"
)
