// Package main provides diagram generation utilities for the go-listen app.
package main
...
const (
	appName     = "go-listen"
	appBinary   = "go-listen"
	appPath     = "apps/go-listen"
	appMainPath = "apps/go-listen"
	outputDir   = "docs/diagrams/go-listen"
)
