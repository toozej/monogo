// Package main provides diagram generation utilities for the ghreleases2rss app.
package main
...
const (
	appName     = "ghreleases2rss"
	appBinary   = "ghreleases2rss"
	appPath     = "apps/ghreleases2rss"
	appMainPath = "apps/ghreleases2rss"
	outputDir   = "docs/diagrams/ghreleases2rss"
)
