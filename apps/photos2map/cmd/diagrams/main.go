// Package main provides diagram generation utilities for the photos2map app.
package main
...
const (
	appName     = "photos2map"
	appBinary   = "photos2map"
	appPath     = "apps/photos2map"
	appMainPath = "apps/photos2map"
	outputDir   = "docs/diagrams/photos2map"
)
