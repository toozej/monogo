// Package main provides diagram generation utilities for the go-sort-out-gh-actions app.
package main
...
const (
	appName     = "go-sort-out-gh-actions"
	appBinary   = "go-sort-out-gh-actions"
	appPath     = "apps/go-sort-out-gh-actions"
	appMainPath = "apps/go-sort-out-gh-actions"
	outputDir   = "docs/diagrams/go-sort-out-gh-actions"
)
