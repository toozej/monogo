// Package main provides diagram generation utilities for the notes2ssg app.
package main
...
const (
	appName     = "notes2ssg"
	appBinary   = "notes2ssg"
	appPath     = "apps/notes2ssg"
	appMainPath = "apps/notes2ssg"
	outputDir   = "docs/diagrams/notes2ssg"
)
