// Package main provides diagram generation utilities for the kmhd2playlist app.
package main
...
const (
	appName     = "kmhd2playlist"
	appBinary   = "kmhd2playlist"
	appPath     = "apps/kmhd2playlist"
	appMainPath = "apps/kmhd2playlist"
	outputDir   = "docs/diagrams/kmhd2playlist"
)
