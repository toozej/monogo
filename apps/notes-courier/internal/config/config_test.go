...
func TestLoadWithEnv(t *testing.T) {
	...
	_ = os.Setenv("DESTINATION", "obsidian")
	_ = os.Setenv("OBSIDIAN_VAULT_PATH", "/tmp/vault")
	_ = os.Setenv("OBSIDIAN_FOLDER", "Imported")
	t.Cleanup(func() {
		...
		_ = os.Unsetenv("OBSIDIAN_VAULT_PATH")
		_ = os.Unsetenv("OBSIDIAN_FOLDER")
	})
	...
	if conf.Destination != "obsidian" || conf.ObsidianVaultPath != "/tmp/vault" || conf.ObsidianFolder != "Imported" {
		t.Errorf("unexpected Obsidian settings: %+v", conf)
	}
}
