...
func TestRootCmdStructure(t *testing.T) {
	if rootCmd.Use != "notes-courier" {
		t.Errorf("expected Use='notes-courier', got '%s'", rootCmd.Use)
	}
	if rootCmd.Short != "Move notes between Simplenote, Memos, Obsidian, Hugo, and go-vite" {
