// Package cmd provides command-line interface functionality for the notes-courier application.
//
...
// execution for the notes-courier application.
package cmd
...
import (
	...
	"github.com/toozej/monogo/apps/notes-courier/internal/converter"
...
// rootCmd defines the base command for the notes-courier CLI application.
var rootCmd = &cobra.Command{
	Use:              "notes-courier",
	Short:            "Move notes between Simplenote, Memos, Obsidian, Hugo, and go-vite",
	Long:             `Notes Courier reads notes from Simplenote, Memos, or an Obsidian vault and writes them to Memos, Obsidian, Hugo, or go-vite.`,
...
func init() {
	...
	// add sub-commands
	rootCmd.AddCommand(
		avatar.NewCommand("notes-courier"),
		man.NewManCmd(),
		version.Command(),
	)
}
