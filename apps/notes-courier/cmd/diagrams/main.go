// Package main provides diagram generation utilities for the notes-courier app.
package main
...
const (
	appName     = "notes-courier"
	appBinary   = "notes-courier"
	appPath     = "apps/notes-courier"
	appMainPath = "apps/notes-courier"
	outputDir   = "docs/diagrams/notes-courier"
)
