// Package main provides diagram generation utilities for the go-castctl app.
package main
...
const (
	appName     = "go-castctl"
	appBinary   = "go-castctl"
	appPath     = "apps/go-castctl"
	appMainPath = "apps/go-castctl"
	outputDir   = "docs/diagrams/go-castctl"
)
